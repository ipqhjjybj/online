...
<div id = "out" align="center">
    ...
    <form action="function/news_insert.php" method="post" onSubmit="return check_news()">
    <table width="883" border="0">
      ...
      <tr>
        <td height="35">概要</td>
        <td colspan="2"><textarea id="news_summary" name = "news_summary"></textarea></td>
        <td>不要为空哦</td>
      </tr>
      <tr>
        <td>时间</td>
      ...
      <tr>
        ...
        <option><?php
					$mysql = new OnlineSqlNew();
					 $res = $mysql->select("news_class","id",$id);
					 if($res->num_rows)
					 echo $res->fetch_object()->class_name;
					 else echo "请选择!"?>
        </option>
        <?php
